...
/**
 * Read data from a special-purpose register of the CPU Core attached to a 
 * Core Debug Module (CDM)
 *
 * @param hostmod_ctx the host module handling the communication
 * @param cdm_di_addr DI address of CDM module 
...
/**
 * Write data from a special-purpose register of the CPU Core attached to a 
 * Core Debug Module (CDM)
 *
 * @param hostmod_ctx the host module handling the communication
 * @param cdm_di_addr DI address of CDM module 
